...
Please install ROS 2 Humble via `deb packages <https://docs.ros.org/en/humble/Installation/Ubuntu-Install-Debs.html>`_ or build `the binaries <https://docs.ros.org/en/humble/Installation/Alternatives/Ubuntu-Install-Binary.html>`_.
